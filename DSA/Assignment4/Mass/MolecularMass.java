...
public class MolecularMass {
     ...
     * @param  int start represents the position from where the array is to be checked 
    ...
    /**
     * molecularMass find the molecular mass by calling mass in specified manner (Calling method of mass)
